<?php
	if(isset($_POST['orden'])){
		...
		$query="INSERT INTO `orden` (`id`, `responsable`, `total`, `estado_id`, `estado_pago_id`, `fecha_inicio`, `fecha_entrega`,`deuda`) VALUES (NULL, '$responsable', '$total', '2', '1', '$hoy', '$fecha_entrega','$total')";
